<template>
  ...
  <div v-else-if="render != null && render" class="vsg_split-grid">
    <slot />
  </div>
...
const VALID_CHILD_COMPONENTS = ['SplitGrid', 'SplitGridArea', 'SplitGridGutter']
  ...
  methods: {
    animateSizeChange({
      ...
      this.animationInterval = setInterval(() => {
        ...
        const intermediateValue = difference * easingFunction(tick / totalTicks)
        gridTemplateStyleParts[elementIndex] = `${
